...
print_help() {
  cat <<'EOF'
Usage:
  bash list-models/anthropic.sh -u <url> -k <key>
...
Examples:
  bash list-models/anthropic.sh -u https://api.anthropic.com/v1 -k sk-ant-...
  bash list-models/anthropic.sh --url http://localhost:10000/v1 --key dummy-key --skip-ssl
EOF
}
